...
TemplateFloatType = Annotated[float, __template_fields]
TemplateEnumType = Annotated[TemplateEnum, __template_fields]
TemplateIntEnumType = Annotated[TemplateIntEnum, __template_fields]
TemplateStrEnumType = Annotated[TemplateStrEnum, __template_fields]
TemplateLiteralType = Annotated[Literal['a', 'b', 'c'], __template_fields]
